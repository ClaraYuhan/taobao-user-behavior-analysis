...
3. 术语解释<br>
T（cohort_date）：指用户首次被统计为“活跃用户”的日期（即在该日发生任意行为）<br>
T+1：用户活跃后的第 1 天，即次日<br>
T+3：用户活跃后的第 3 天<br>
D1 留存率：在 cohort_date 当天活跃的用户中，有多少在 T+1（次日）仍活跃<br>
D3 留存率：在 cohort_date 当天活跃的用户中，有多少在 T+3（第三天）仍活跃<br>
